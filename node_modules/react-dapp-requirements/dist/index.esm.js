    ...
    createClass(CheckForBrowser, [{
        ...
        value: function render() {
            ...
            if (!isBrowserSupported()) {
                return React.createElement(BrowserUnsupportedComponent, null);
            }
    ...
    createClass(CheckForNetwork, [{
        ...
        value: function render() {
            ...
            if (!this.state.hasNetworkConnection) {
                return React.createElement(NetworkNotFoundComponent, null);
            }

            if (!isSupportedNetwork) {
                return React.createElement(NetworkNotSupportedComponent, { currentNetwork: this.getNetworkById(this.state.networkId),
    ...
    createClass(DappRequirements, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                React.Fragment,
                null,
                !bypassChecks ? React.createElement(
                    CheckForBrowser,
...
export { CheckForBrowser, CheckForWeb3, CheckForNetwork, CheckForAccount, DappRequirements };
